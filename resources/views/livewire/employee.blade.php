        ...
        <table class="table-auto">
              <thead>
                <tr>
                  ...
                  <th class="px-3 py-3 mt-3">Actions</th>
                </tr>
              </thead>
              <tbody>
                  @foreach ($employees as $employee )
                  <tr>
                      <td class="border px-3 py-3 mt-3">{{$employee->name}}</td>
                      <td class="border px-3 py-3 mt-3">{{$employee->phone_number}}</td>
                      <td class="border px-3 py-3 mt-3">{{$employee->email}}</td>
